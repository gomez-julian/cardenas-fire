    ...
    $.fn.imageUploadResizer = function (options) {
      ...
      this.filter('input[type="file"]').each(function () {
        this.onchange = function () {
          ...
          if (
            settings.do_not_resize.includes("*") ||
            settings.do_not_resize.includes(originalFile.type.split("/")[1])
          ) {
            return;
          }
